...
public class AnotherProjectRestApiCallClientTest {

	public void createTopic(Topic topic) {
		Client client=null;
		try {
			client=ClientBuilder.newClient();
			WebTarget target=client.target("http://localhost:9090/topics");
	...
	public void updateTopic(Topic topic) {
		...
		try {
			client = ClientBuilder.newClient();
			WebTarget base = client.target("http://localhost:9090/topics");
	...
	public void getTopicById(int topicId) {
		...
		try {
			client = ClientBuilder.newClient();
			WebTarget base = client.target("http://localhost:9090/topics/topicId");
	...
	public void deleteTopic(int topicId) {
		...
		try {
			client = ClientBuilder.newClient();
			WebTarget target = client.target("http://localhost:9090/topics/topicId");
	...
	public static void main(String[] args) {
		AnotherProjectRestApiCallClientTest jerseyClient = new AnotherProjectRestApiCallClientTest();
